<?php
	...
	function generar_reporte($instancia){
		...
		if(!$curso){
			echo "<br/><h3 align='center'>Aún no se han ingresado los datos suficientes. Revisar que el curso tenga una sección creada y tenga un tutor académico asignado</h3>";
		}else{
